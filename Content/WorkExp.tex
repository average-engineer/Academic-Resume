...
\large{\textbf{Scientific Employee}}
\hfill
%\hspace{2.9 in}
\large{\textbf{November 2024 - Ongoing}}\\
...
\large{\textbf{Energy Efficient Locomotion of Bipedal Robots}}
%\masterarbeitBetreuer
\begin{itemize}
	\item Development and real-time implementation of controller strategies and architectures to achieve energy efficient bipedal locomotion including walking, running and jumping.
	\item Development and assembly of bipedal robot prototypes equipped to facilitate real-time locomotion experiments under laboratory conditions.
	\item Supervision of student assistants, bachelor and master theses involved in prototype development
	\item Teaching assistant for the courses: \href{https://www.itm.kit.edu/dynamik/Lehre_2497.php}{Introduction to Multibody Dynamics}, \href{https://www.itm.kit.edu/dynamik/4358_2753.php}{Engineering Mechanics 3} and \href{https://www.itm.kit.edu/dynamik/Lehre_MM_Schwingungslehre_Uebung.php}{Mathematical Methods in Vibration Theory}
	\item All research activity including publications, talks, supervised theses can be referred from the \href{https://www.itm.kit.edu/dynamik/Mitarbeiter_Mukherjee.php}{\emph{Institute Website}}.
\end{itemize}
